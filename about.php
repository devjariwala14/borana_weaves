                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <h1 class="hs-title-1 mb-40">
                            <span class="wow charsAnimIn" data-splitting="chars">Crafting the Future <br> of
                                Textiles</span>
                        </h1>
                        ...
                        <div class="mt-n10 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1.2s">
                            ...
                            <div class="d-inline-flex mt-10 mx-3">
                                ...
                                <div class="features-list-text">Based in Surat</div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 mb-xs-50">
                    <div class="call-action-4-images">
                        <div class="call-action-4-image-1">
                            <img src="images/image-1.png" alt="Image description" class="wow scaleOutIn"
                                data-wow-duration="1.2s" />
                        </div>
                        <div class="call-action-4-image-2" data-rellax-y data-rellax-speed="0.7"
                            data-rellax-percentage="0.25">
                            <img src="images/image-2.png" alt="Image description" class="wow scaleOutIn"
                ...
                <div class="col-sm-7 col-xl-6 offset-xl-1 mt-n10">
                    <div class="wow linesAnimIn" data-splitting="lines">
                        <p class="lead text-capitalize mt-0 mb-40"> Our Leadership</p>
                        <p class="text-gray mb-40">
                            <span class="text-dark fw-semibold">Mr. Mangilal Borana</span> - Chairman of Borana
                            Weaves is the visionary behind our enterprise,
                            established the company with a relentless drive and a clear vision for the future.
                            His leadership has been pivotal in guiding the company from its humble beginnings to
                            its current status as a leading textile manufacturer.
                        </p>
                        <p class="text-gray mb-40">
                            <span class="text-dark fw-semibold">Mr. Rajkumar Borana</span> - Director of Borana
                            Weaves, the elder son of Mangilal Borana,
                            plays a crucial role in strategic decision-making and business development.
                            His innovative ideas and leadership have been instrumental in driving the company’s
                            growth and diversification.
                        </p>
                        <p class="text-gray mb-40">
                            <span class="text-dark fw-semibold">Mr.Ankur Borana</span>- Director of Borana
                            Weaves, the younger son, complements the leadership team
                            with his dynamic approach and modern outlook. His contributions have been vital in
                            incorporating advanced technologies and expanding the company’s capabilities.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="item-carousel owl-carousel">
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-descr">
                            Mangilal Borana established the company, leading it from a small
                            startup to a leading textile manufacturer.
                        </div>
                    </div>
                    <!-- End Features Item -->
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-descr">
                            In 1983, Borana Weaves entered industrial manufacturing with 24
                            looms, marking its significant industry entry.
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-descr">
                            Between 1995 and 1997, the company diversified into craft paper manufacturing,
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-descr">
                            Adoption of water jet weaving looms in 2005 significantly improved production
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-title">
                            Expansion into Denim
                        </div>
                        <div class="features-descr">
                            In 2012, the company entered the denim industry, eventually scaling up production
                            to 30 million meters per year by 2016.
                        </div>
                    </div>
                    <!-- End Features Item -->
                    ...
                    <div class="features-item">
                        ...
                        <div class="features-descr">
                            Partnering with Hogivala Infra Ltd., Borana Weaves recycles 3.6 million liters of
                            water daily,
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                    ...
                    <h2 class="section-caption mb-xs-10 wow fadeInUp">Our Creative Team</h2>
                    <h3 class="section-title mb-50 mb-sm-30"><span class="wow charsAnimIn"
                            data-splitting="chars">Discover the people who make our web studio stand out.</span>
                    </h3>
                </div>
            </div>

            <div class="row position-relative mt-n40 wow fadeInUp" data-wow-delay="0.1s">
                <!-- Decorative Waves -->
                <div class="decoration-8 d-none d-sm-block" data-rellax-y data-rellax-speed="-0.6"
                    data-rellax-percentage="0">
                    <img src="images/decoration-1.svg" alt="" />
                </div>
                <!-- End Decorative Waves -->
                <!-- Team item -->
                <div class="col-sm-6 col-lg-4 mt-40">
                    <div class="team-item">
                        <div class="team-item-image" style="height: 500px;">
                            <img src="images/team/person-3.webp" alt="Image Description" />
                        </div>
                        <div class="team-item-descr">
                            <div class="team-item-name">Mr mangilal Borana</div>
                            <div class="team-item-role">Founder of Borana Weaves</div>
                        </div>
                    </div>
                </div>
                <!-- End Team item -->
                ...
                <div class="col-sm-6 col-lg-4 mt-40">
                    <div class="team-item">
                        <div class="team-item-image" style="height: 500px;">
                            <img src="images/team/mr_raju_borana.JPG" alt="Image Description" />
                        </div>
                        <div class="team-item-descr">
                            <div class="team-item-name">Mr Raju Borana</div>
                            <div class="team-item-role">Director of Borana Weaves</div>
                        </div>
                    </div>
                </div>
                <!-- End Team item -->
                ...
                <div class="col-sm-6 col-lg-4 mt-40">
                    <div class="team-item">
                        ...
                        <div class="team-item-image" style="height: 500px;">
                            <img src="images/team/Mr ankur borana.jpg" alt="Image Description" />
                        </div>

                        <div class="team-item-descr">
                            <div class="team-item-name">Mr Ankur Borana</div>
                            <div class="team-item-role">Director of Borana Weaves</div>
                        </div>
            ...
            <div class="row position-relative">
                ...
                <div class="col-md-6 col-lg-5 mb-md-50 mb-sm-30">
                    ...
                    <p class="text-gray mb-0">
                        Borana Weaves excels in innovative textile manufacturing, integrating cutting-edge
                        technology with sustainable practices. From early industrial growth to significant
                        expansions in advanced water jet looms, their expertise ensures top-quality synthetic
                        and blended greige fabrics, driving industry standards.
                    </p>
                ...
                <div class="col-md-6 offset-lg-1 pt-10 pt-sm-0">
                    ...
                    <div class="progress tpl-progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0"
                            aria-valuemax="100">
                            <div>Textile Manufacturing, %</div> <span>100</span>
                        </div>
                    </div>
                    <!-- End Bar Item -->
                    ...
                    <div class="progress tpl-progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="0"
                            aria-valuemax="100">
                            <div>Innovative Textile Solutions, %</div> <span>95</span>
                        </div>
                    </div>
                    <!-- End Bar Item -->
                    ...
                    <div class="progress tpl-progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0"
                            aria-valuemax="100">
                            <div>Denim Production, %</div> <span>85</span>
                        </div>
                    </div>
                    <!-- End Bar Item -->
                    ...
                    <div class="progress tpl-progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0"
                            aria-valuemax="100">
                            <div>Advanced Weaving Technologies, %</div> <span>75</span>
                        </div>
                    </div>
                    <!-- End Bar Item -->
                    ...
                    <div class="progress tpl-progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0"
                            aria-valuemax="100">
                            <div>Business Diversification, %</div> <span>90</span>
                        </div>
                    </div>
                    <!-- End Bar Item -->
