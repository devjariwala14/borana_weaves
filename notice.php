...
$stmt = $obj->con1->prepare("SELECT * FROM `investors_data` id1,`investors_menu` im1 WHERE id1.inv_menu_id=im1.id and im1.menu_name='Notices';");
$stmt->execute();
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <h1 class="hs-title-1 mb-20">
                            <span class="wow charsAnimIn" data-splitting="chars">Notices</span>
                        </h1>
