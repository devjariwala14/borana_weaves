...
$stmt_product = $obj->con1->prepare("SELECT * FROM `investors_data` inv,investors_menu im where inv.inv_menu_id=im.id and im.menu_name='Shareholding Pattern'");
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <h1 class="hs-title-1 mb-20">
                            <span class="wow charsAnimIn" data-splitting="chars">Shareholding Pattern</span>
                        </h1>
