 ...
 if(isset($_REQUEST["btndelete"]))
{
  ...
  try
  {
    $stmt_del = $obj->con1->prepare("DELETE FROM `investors_contact` WHERE id = ?");
...
function add_data() {
    eraseCookie("edit_id");
    eraseCookie("view_id");
    window.location = "add_investor_contact.php";
}
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="investor_contact.php">
...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Investor Contact</li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
                            $stmt = $obj->con1->prepare("SELECT * FROM `investors_contact` ORDER BY `id` DESC");
                            $stmt->execute();
