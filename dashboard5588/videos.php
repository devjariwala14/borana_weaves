 ...
 if (isset($_REQUEST["btndelete"])) {
    $s_id = $_REQUEST['delete_id'];
     ...
     try {
         ...
         if (file_exists("images/videos/" . $Resp_subimg["image"])) {
             unlink("images/videos/" . $Resp_subimg["image"]);
         }
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        $img_array = array("mp4", "avi", "mov", "wmv","MP4","flv");
                                        $extn = strtolower(pathinfo($row["video"], PATHINFO_EXTENSION));
                                        if (in_array($extn, $img_array)) {
                                        ?>
                                    <img src="images/videos/<?php echo $row["video"]; ?>" width="200" height="200"
