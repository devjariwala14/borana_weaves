 ...
 if(isset($_REQUEST["btndelete"]))
{
  ...
  try
  {
    $stmt_del = $obj->con1->prepare("DELETE FROM `ldor` WHERE id = ?");
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="ldor.php">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
                            $stmt = $obj->con1->prepare("SELECT * FROM `ldor` ORDER BY `id` DESC");
                            $stmt->execute();
